          ...
          <li class="nav-item <?php if($this->uri->segment(1)=="drmd_request_r"){echo "active";}?>">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link <?php if($this->uri->segment(1)=="drmd_request_r"){echo "active";}?>" href="drmd_request_r">Request Entry</a></li>
                <li class="nav-item"><a class="nav-link <?php if($this->uri->segment(1)=="drmd_entries_r"){echo "active";}?>" href="drmd_entries_r">My entries (<?php echo $cound_drmd_entry; ?>)</a></li>
                 <li class="nav-item"><a class="nav-link <?php if($this->uri->segment(1)=="drrs_disapprove_r"){echo "active";}?>" href="drmd_disapproved_r">Disapproved Entries (<?php echo $count_disapproved; ?>)</a></li>
                <li class="nav-item"><a class="nav-link <?php if($this->uri->segment(1)=="drmd_ris_repo_r"){echo "active";}?>" href="drmd_ris_repo_r">RIS repo (<?php echo $count_ris_dr_mod; ?>)</a></li>
