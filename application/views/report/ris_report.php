...
$pdf->SetTitle(substr($data['provDesc'],0,3).'-'.$data['ris_no']);
...
$html = '
    ...
    <tr>
        ...
        <th style="width:40%; border-left-color:#ffffff;"><img src="assets/images/DSWD-FO7-INSIGNIA.jpg" height="40" width="110"></th>
    ...
    $html .= ' <tr>
     ...
     <tr>
        ...
        <th style="width:33%"><small>'.ucfirst(strtolower($data['provDesc'])).' Warehouse</small></th>
    ...
    <tr>
        ...
        <th style="width:33%"><small>'.$data['address'].'</small></th>
    ...
    foreach($data1 as $key => $value){
        ...
        $html .= '<tr>
            <th style="width:8.5% ;text-align:center;"><small><b>'.$value['stockCode'].'</b></small></th>
            <th style="width:8.5% ;text-align:center;"><small><b>'.$value['description'].'</b></small></th>
            <th style="width:24.5% ;text-align:center;"><small><b>'.$value['itemdescription'].'</b></small></th>
            <th style="width:8.5% ;text-align:center;"><small><b>'.number_format($value['qty_released']).'</b></small></th>
        ...
        if($value['item'] == 16){
            $html .= '<tr>
                ...
                <th style="width:8.5% ;text-align:center;"></th>
                <th style="width:24.5% ;text-align:center;"><small>(6 Kilos Rice, 4 tins canned meat, 2 tins sardines, 4 tins canned tuna, 5 sachets coffe and 5 sachets powdered cereal milk)</small></th>
                <th style="width:8.5% ;text-align:center;"></th>
                <th style="width:8.5% ;text-align:center;"></th>
                <th style="width:8.5% ;text-align:center;"></th>
                <th style="width:8.5% ;text-align:center;"></th>
    ...
    <tr>
        ...
        <th style="width:33% ;text-align:left;"><small>'.$value['citymunDesc'].', '.$value['provDesc'].'</small></th>
    ...
    <tr>
        ...
        <th style="width:33% ; text-align:center;"><small>'.$_GET['purpose'].'</small></th>
...
$pdf->Output(substr($data['provDesc'],0,3).'-'.$data['ris_no'].'.pdf', 'I');
