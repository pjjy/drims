                          ...
                          <div class="d-sm-flex justify-content-between align-items-start">
                                ...
                                <div class="row">
                                      ...
                                      <div class="table-responsive">
                                        <table id="drrs_table" class="" style="width:100%">
                                              ...
                                              <tbody>
                                                  <?php
                                                    foreach($get_delinquent as $key =>  $value){ 
                                                      ...
                                                      '<tr>
                                                        ...
                                                        <td>
                                                         ...
                                                         <a data-id="'.$value['drid'].'" data-id1="'.$value['reference_no'].'" data-id2="'.$incident_name.'" data-id3="'.$value['provDesc'].'" data-id4="'.$value['citymunDesc'].'" data-id5="'.$requester_name.'" data-id6="'.$value['disctrictcode'].'" class="rros_process_delinquent" href="javascript:void(0);"><i class="icon-play"></i> Process</a></td>
                                                      </tr> ';
                                                    } 
                                                  ?>
                                ...
                                <div class="row autofilled">
                                 ...
                                 <!-- <div class="row">
                                     ...
                                     <div class="col-md-4">
                                       <div class="form-group">
                                          <label for="exampleFormControlSelect2">DATE COORDINATION LETTER FOR PULL-OUT FORWARDED TO DRMD</label>
                                            <div id="datepicker-popup" class="input-group date datepicker navbar-date-picker">
                                            <span class="input-group-addon input-group-prepend border-right">
                                              <span class="icon-calendar input-group-text calendar-icon"></span>
                                            </span>
                                  ...
                                  <div class="assist">
                                   ...
                                   <div class="row">
                                    <div class="col-md-2">
                                       ...
                                       <a href="javascript:void(0)" class="btn btn-otline-dark rros_save_req1"><i class="icon-briefcase"></i> Save</a> 
                                    </div>
                                  </div>
                                 </div>
                              </div>
